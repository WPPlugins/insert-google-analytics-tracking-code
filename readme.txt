...
[Everyday Publishing](https://www.everydaypublishing.com.au/insert-google-analytics-tracking-code-wordpress-plugin/)
...
== Changelog ==
= 1.0.5
*	Moved the tracking code into the <head> section for greater compatibility
 with Google’s Webmaster Tools.

= 1.0.4 =
*	Fixed an issue with the header information that gave an invalid
	header error during installation.
= 1.0.3 =
...
*	Tested comaptibility with WordPress 4.7.3
...
= 1.0.1 =
Superficial changes to fix typo in the settings page, and update this README file
